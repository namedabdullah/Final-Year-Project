    ...
    <div className="relative min-h-screen bg-background overflow-x-hidden">
      ...
      >
        <div className="px-8 pb-24 w-full">
          <h1 className="text-4xl font-bold text-foreground mb-20">Joined Classrooms</h1>
          ...
          <div className="w-full max-w-[1600px] mx-auto px-16">
            {loadingClassrooms ? (
              ...
              <p className="mt-16 text-sm text-muted-foreground">You haven't joined any classrooms yet.</p>
            ) : (
