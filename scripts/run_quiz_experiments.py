...
# Note: complexity_match / reasoning_match in each quiz are already computed
# deterministically server-side (floor-based complexity, tier-based reasoning —
# see lightrag/quiz/verification.py); this runner just reads those flags.
...
def task_compare(args) -> int:
    ...
    metrics = [
        ...
        "pedagogical_value_mean", "answer_completeness_mean", "answer_correctness_mean",
